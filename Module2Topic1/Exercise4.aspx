...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="rfvcandidate"
            ...
            ErrorMessage="Full Name is Required." Display="Dynamic" /><br />
        ...
        <asp:RangeValidator ID="rvAge" runat="server" ControlToValidate="age"
            ErrorMessage="Enter your age (1 - 100)." MinimumValue="0" MaximumValue="100" Type="Integer"/>
        ...
        <asp:RegularExpressionValidator ID="revEmail" runat="server" ControlToValidate="email"
            ErrorMessage="Invalid email format." ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" Display="Dynamic" /><br />
        ...
        <asp:CompareValidator ID="cvConfirmEmail" runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" errorMessage="Email addresses do not match." Display="Dynamic" /><br />

        <asp:Button Text="Submit" runat="server" UseSubmitBehavior="true" OnClick="SubmitForm" />
