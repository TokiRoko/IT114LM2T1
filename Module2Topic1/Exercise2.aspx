...
<body>
    ...
    <form runat="server">
        ...
        <asp:CheckBoxList ID="cblPerformanceAttending" runat="server">
            <asp:ListItem Text="Drake"></asp:ListItem>
            <asp:ListItem Text="Jason Derulo"></asp:ListItem>
            <asp:ListItem Text="Michael Jackson"></asp:ListItem>
        </asp:CheckBoxList><br />
        ...
        Proof of Payment (JPG/PNG Only): <asp:FileUpload ID="fileProofOfPayment" runat="server" accept=".jpg,.png" /><br />
    </form>
</body>
</html>
